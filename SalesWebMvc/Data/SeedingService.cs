...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public SeedingService(SalesWebMvcContext cotext)
        {
            _context = cotext;
        }
        ...
        public void Seed()
        {
            //A função Any() verfica se existe algum registro dentro da tabela
            if(_context.Department.Any() ||
                _context.Seller.Any() ||
                _context.SalesRecord.Any())
            {
                return; //DB has been seeded -> O banco de dados já foi populado
            }
            ...
            Seller s1 = new Seller("Bob Brown", "bob@gmail.com", new DateTime(1999,4,21), 1000.0,d1);
            Seller s2 = new Seller("Maria Green", "maria@gmail.com", new DateTime(1979,12,31), 3500.0,d2);
            Seller s3 = new Seller("Alexy Grey", "alex@gmail.com", new DateTime(1988,1,15), 2200.0, d1);
            ...
            Seller s6 = new Seller("Alex Pink", "alex@gmail.com", new DateTime(1997,3,4),3000.0, d2);
            ...
            //AddRange permite que eu adicione varios objetos de uma só vez no banco de dados.
            //The method AddRange allow me to add many objects at the same time to the data source.
            ...
            //SaveChanges(); Save and confirm the changes in the data base.
            //SaveChanges(); Salva e confirma as mudanças no banco de dados.
